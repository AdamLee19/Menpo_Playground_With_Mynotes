...
class RichCompareTests:
    ...
    def check_tracker(self, object, trait, old, new, count):
        ...
        self.assertTrue(object is self.changed_object)
        self.assertEqual(trait, self.changed_trait)
        self.assertTrue(old is self.changed_old)
        self.assertTrue(new is self.changed_new)
        return
...
class RichCompareHasTraitsTestCase(unittest.TestCase, RichCompareTests):
    ...
    def test_assumptions(self):
        self.assertFalse(self.a is self.same_as_a)
        self.assertFalse(self.a is self.different_from_a)

        self.assertTrue(self.a.name == self.same_as_a.name)
        self.assertFalse(self.a.name == self.different_from_a.name)
        return
### EOF
