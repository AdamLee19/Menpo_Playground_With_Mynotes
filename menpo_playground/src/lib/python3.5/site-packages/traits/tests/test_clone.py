...
class CloneTestCase(unittest.TestCase):
    ...
    def test_Any_circular_references(self):
        ...
        self.assertFalse(bar_copy is bar)
        self.assertTrue(bar_copy.other is baz)
        self.assertTrue(bar_copy.other.other is bar)
    ...
    def test_Any_circular_references_deep(self):
        ...
        self.assertFalse(bar_copy is bar)
        self.assertFalse(bar_copy.other is baz)
        self.assertFalse(bar_copy.other.other is bar)
        self.assertTrue(bar_copy.other.other is bar_copy)
    ...
    def test_Instance_circular_references(self):
        ...
        self.assertFalse(baz_copy is baz)
        self.assertFalse(baz_copy.other is bar)
        self.assertFalse(baz_copy.unique is baz.unique)
        self.assertFalse(baz_copy.shared is baz.shared)
        self.assertTrue(baz_copy.ref is ref)

        # Check Bar and Bar attributes....
        bar_copy = baz_copy.other

        # Check the Bar owned object
        self.assertFalse(bar_copy.unique is bar.unique)

        # Check the Bar reference to an object 'outside' the cloned graph.
        self.assertTrue(bar_copy.ref is ref)
        ...
        self.assertFalse(bar_copy.other is baz_copy)
        self.assertTrue(bar_copy.other is baz)

        # 'shared' does not have copy set to 'ref', and so bar_copy.shared
        # should reference the new clone.
        # should reference the new clones
        self.assertFalse(bar_copy.shared is baz.shared)
        self.assertTrue(bar_copy.shared is baz_copy.shared)
    ...
    def test_Instance_circular_references_deep(self):
        ...
        # 'ref'.
        self.assertTrue(baz_copy.ref is bar_copy.ref)
        self.assertTrue(bar_copy.ref is ref)
