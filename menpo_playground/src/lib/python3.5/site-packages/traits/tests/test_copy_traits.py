...
class TestCopyTraitsSetup(CopyTraitsBase):
    ...
    def test_setup(self):
        self.assertTrue(self.foo is self.bar.foo)
        self.assertTrue(self.bar is self.baz.bar)
        self.assertTrue(self.foo.shared is self.shared)
        self.assertTrue(self.bar.shared is self.shared)
        self.assertTrue(self.baz.shared is self.shared)

        self.assertTrue(self.foo2 is self.bar2.foo)
        self.assertTrue(self.bar2 is self.baz2.bar)
        self.assertTrue(self.foo2.shared is self.shared2)
        self.assertTrue(self.bar2.shared is self.shared2)
        self.assertTrue(self.baz2.shared is self.shared2)
        return
...
class CopyTraits:
    ...
    def test_baz2_bar(self):
        ...
        self.assertFalse(self.baz2.bar is None)
        self.assertFalse(self.baz2.bar is self.bar2)
        self.assertFalse(self.baz2.bar is self.baz.bar)

    def test_baz2_bar_foo(self):
        # Second hand Instance trait is a different object and
        # is not the same object as the source.

        self.assertFalse(self.baz2.bar.foo is None)
        self.assertFalse(self.baz2.bar.foo is self.foo2)
        self.assertFalse(self.baz2.bar.foo is self.baz.bar.foo)
...
class CopyTraitsSharedCopyNone:
    def test_baz2_shared(self):
        ...
        self.assertFalse(self.baz2.shared is None)
        self.assertFalse(self.baz2.shared is self.shared2)
        self.assertFalse(self.baz2.shared is self.shared)
    ...
    def test_baz2_bar_shared(self):
        ...
        self.assertFalse(self.baz2.bar.shared is None)
        self.assertFalse(self.baz2.bar.shared is self.shared2)
        self.assertFalse(self.baz2.bar.shared is self.shared)
        self.assertFalse(self.baz2.bar.shared is self.baz2.shared)
    ...
    def test_baz2_bar_foo_shared(self):
        ...
        self.assertFalse(self.baz2.bar.foo.shared is None)
        self.assertFalse(self.baz2.bar.foo.shared is self.shared2)
        self.assertFalse(self.baz2.bar.foo.shared is self.shared)
        self.assertFalse(self.baz2.bar.foo.shared is self.baz2.shared)
    ...
    def test_baz2_bar_and_foo_shared(self):
        ...
        self.assertTrue(self.baz2.bar.shared is self.baz2.bar.foo.shared)
        self.assertFalse(self.baz2.shared is self.baz2.bar.foo.shared)
...
class TestCopyTraitsSharedCopyNone(CopyTraits,
    ...
    def setUp(self):
        print('\n***TestCopyTraitsSharedCopyNone', end=' ')
...
class TestCopyTraitsCopyNotSpecified(CopyTraitsBase,
    ...
    def setUp(self):
        print('\n*TestCopyTraitsCopyNotSpecified', end=' ')
...
class CopyTraitsSharedCopyRef:
    def test_baz2_shared(self):
        ...
        self.assertFalse(self.baz2.shared is None)
        self.assertFalse(self.baz2.shared is self.shared2)
        self.assertTrue(self.baz2.shared is self.shared)

    def test_baz2_bar_shared(self):
        self.assertFalse(self.baz2.bar.shared is None)
        self.assertFalse(self.baz2.bar.shared is self.shared2)
        self.assertTrue(self.baz2.bar.shared is self.shared)
        self.assertTrue(self.baz2.bar.shared is self.baz2.shared)

    def test_baz2_bar_foo_shared(self):
        self.assertFalse(self.baz2.bar.foo.shared is None)
        self.assertFalse(self.baz2.bar.foo.shared is self.shared2)
        self.assertTrue(self.baz2.bar.foo.shared is self.shared)
        self.assertTrue(self.baz2.bar.foo.shared is self.baz2.shared)

    def test_baz2_bar_and_foo_shared(self):
        self.assertTrue(self.baz2.bar.shared is self.baz2.bar.foo.shared)
        self.assertTrue(self.baz2.shared is self.baz2.bar.foo.shared)
...
class TestCopyTraitsSharedCopyRef(CopyTraits,
    ...
    def setUp(self):
        print('\n***TestCopyTraitsSharedCopyRef.setUp ', end=' ')
...
class TestCopyTraitsCopyNotSpecifiedSharedRef(CopyTraitsBase,
    ...
    def setUp(self):
        print('\n*TestCopyTraitsCopyNotSpecifiedSharedRef.setUp', end=' ')
        CopyTraitsBase.setUp(self)
...
class TestCopyTraitsCopyShallowSharedRef(CopyTraitsBase,
    ...
    def setUp(self):
        print('\n*TestCopyTraitsCopyShallowSharedRef.setUp', end=' ')
        CopyTraitsBase.setUp(self)
        TestCopyTraitsSharedCopyRef.setUp(self)
        self.baz2.copy_traits(self.baz, copy='shallow')
        return
...
class TestCopyTraitsCopyDeepSharedRef(CopyTraitsBase,
    ...
    def setUp(self):
        print('\n*TestCopyTraitsCopyDeepSharedRef.setUp', end=' ')
        CopyTraitsBase.setUp(self)
        TestCopyTraitsSharedCopyRef.setUp(self)
        self.baz2.copy_traits(self.baz, copy='deep')
        return
