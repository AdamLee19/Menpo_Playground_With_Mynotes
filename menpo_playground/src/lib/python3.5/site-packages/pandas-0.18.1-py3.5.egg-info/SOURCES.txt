...
doc/source/whatsnew/v0.8.1.txt
doc/source/whatsnew/v0.9.0.txt
...
pandas/io/tests/parser/index_col.py
pandas/io/tests/parser/multithread.py
...
pandas/io/tests/parser/data/iris.csv
pandas/io/tests/parser/data/salary.table.csv
pandas/io/tests/parser/data/salary.table.gz
pandas/io/tests/parser/data/test1.csv
pandas/io/tests/parser/data/test1.csv.bz2
pandas/io/tests/parser/data/test1.csv.gz
pandas/io/tests/parser/data/test2.csv
pandas/io/tests/parser/data/tips.csv
pandas/io/tests/parser/data/unicode_series.csv
pandas/io/tests/parser/data/utf16_ex.txt
...
pandas/msgpack/_packer.cpp
pandas/msgpack/_packer.pyx
pandas/msgpack/_unpacker.cpp
...
pandas/tests/types/__init__.py
